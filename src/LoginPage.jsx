                ...
                <div className="w-full max-w-md bg-gradient-to-b from-[#115e59] to-[#0f172a] p-8 md:p-12 rounded-3xl shadow-2xl border border-white/10 relative overflow-hidden">
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="flex flex-row justify-center gap-4 pt-4">
                            <Link to="/signup" className="flex-1 border border-white/30 text-white py-3 rounded-full font-bold text-center hover:bg-white/5 transition-colors uppercase text-sm tracking-wider">
                                Đăng Ký
                            </Link>
